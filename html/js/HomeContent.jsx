    ...
    <div className="app-container">
      <header className="app-header">
        <div>
          ...
          <p className="site-tagline">Web bán hàng cơ bản bằng React</p>
        </div>
      ...
      <main className="main-content">
        ...
        >
          <div className="hero-content">
            ...
            <p className="hero-description">{slides[slideIndex].description}</p>
          </div>
          <button
            onClick={() =>
              setSlideIndex((prev) =>
        ...
        <p className="section-subtitle">
          Chào mừng đến với cửa hàng của chúng tôi! Dưới đây là một số sản phẩm
          mẫu.
        </p>
          ...
          {products.map((product) => (
            <div key={product.id} className="product-card">
              ...
              <div className="product-info">
                ...
                <button className="product-button">Mua ngay</button>
              </div>
            </div>
          ))}
        </div>
      ...
      <footer id="contact" className="footer">
        <p style={{ margin: 0 }}>
          © 2026 Shop Demo. Liên hệ: zalo@demostore.vn - Số điện thoại:
          0123456789
        </p>
      </footer>
    </div>
